...
public enum TextFormatting {
    ...
    /**
     * Matches formatting codes that indicate that the dimension should treat the following text as bold, recolored,
     * obfuscated, etc.
     */
    ...
    /**
     * The control string (section sign + formatting code) that can be inserted into dimension-side text to display
