...
public class JColor extends Color {
	...
	public JColor setRed(int red) {
		return new JColor(red, getGreen(), getBlue(), getAlpha());
	}

	public JColor setGreen(int green) {
		return new JColor(getRed(), green, getBlue(), getAlpha());
	}

	public JColor setBlue(int blue) {
		return new JColor(getRed(), getGreen(), blue, getAlpha());
	}

	public JColor setAlpha(int alpha) {
		return new JColor(getRed(), getGreen(), getBlue(), alpha);
	}
}